...
public class ReplyController {
	...
	public ResponseEntity<String> modify(@RequestBody ReplyVO vo,@PathVariable("rno") Long rno){
		...
		log.info("==rno==>"+rno);
		log.info("==vo==>"+vo);
		return service.modify(vo)==1? new ResponseEntity<String>("secress",HttpStatus.OK):new ResponseEntity<String>(HttpStatus.INTERNAL_SERVER_ERROR);
	}
	///////
}
